...
export default function Login() {
  ...
  async function handleLogin(demoEmail, demoPassword) {
    ...
    setError('')
    try {
      const user = await auth.login(targetEmail, targetPassword)
    ...
    <div className="min-h-screen bg-ivory flex items-center justify-center p-4">
      ...
      >
        ...
        >
          ...
          <div className="space-y-4 mb-6">
            <div className="space-y-2">
              <label htmlFor="email" className="block text-[10px] font-medium text-stone-500 uppercase tracking-[0.15em]">
                Email
              </label>
              <input
                id="email"
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="block text-[10px] font-medium text-stone-500 uppercase tracking-[0.15em]">
                Contraseña
              </label>
              <input
                id="password"
              ...
              {DEMO_ACCOUNTS.map((u, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[9px] font-semibold uppercase tracking-[0.1em] text-wine bg-wine/5 px-3 py-1 rounded-full">
                      {u.label}
                    </span>
        ...
        <p className="text-center text-sm text-stone-400 mt-8">
          ¿No tenés cuenta?{' '}
          <Link to="/registro" className="text-wine hover:text-wine-light font-medium transition-colors">
            Registrate
          </Link>
        </p>
      </motion.div>
