    ...
    <div className="flex-1 bg-white min-h-screen">
      <section className="bg-ivory py-20 sm:py-28">
        <div className="max-w-[900px] mx-auto px-6 text-center">
          <m.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-gold text-[10px] tracking-[0.4em] uppercase mb-4 font-medium">Para revendedores</m.p>
          <m.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl sm:text-5xl text-stone-800 mb-6" style={{ fontFamily: 'var(--font-display)' }}>Catálogo sin marca</m.h1>
          <m.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-stone-500 text-lg max-w-xl mx-auto font-light leading-relaxed">
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-20 sm:py-24">
        <m.div {...fadeUp} className="text-center mb-16"><h2 className="text-3xl text-stone-800" style={{ fontFamily: 'var(--font-display)' }}>Cómo funciona</h2></m.div>
        <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
          {[
            ...
            <m.div key={s.step} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.12 }} className="text-center">
