    ...
    <div className="flex-1 bg-white min-h-screen">
      <div className="max-w-[900px] mx-auto px-6 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-20"><Package size={48} className="text-stone-200 mx-auto mb-4" /><p className="text-stone-500" style={{ fontFamily: 'var(--font-display)' }}>No tienes pedidos aún</p></div>
        ) : (
              ...
              <motion.div key={order.id} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }}
                ...
                <div className="px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-4">
                    <p className="text-lg font-semibold text-stone-800" style={{ fontFamily: 'var(--font-display)', fontVariantNumeric: 'tabular-nums' }}>{formatCOP(order.total)}</p>
                      ...
                      <div className="px-6 pb-5 border-t border-stone-100">
                        <div className="pt-4">
                          ...
                          <div className="border-t border-stone-100 mt-3 pt-3 flex justify-between items-baseline">
                            ...
                            <span className="text-xl font-bold text-wine" style={{ fontFamily: 'var(--font-display)' }}>{formatCOP(order.total)}</span>
                          </div>
                        </div>
                      </div>
                    </motion.div>
