      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="space-y-6">
            {currentStep === 1 && (
              <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="rounded-[26px] border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            {currentStep === 4 && (
              <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[26px] border border-stone-200 bg-white px-6 py-16 text-center shadow-sm sm:px-10">
