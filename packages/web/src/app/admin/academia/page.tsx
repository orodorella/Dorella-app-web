    ...
    <div className="min-w-0 space-y-6">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-stone-400">Gestión de cursos y contenido</p>
        </div>
        <button
          onClick={openCreate}
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-wine px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-wine-light"
        >
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {courses.map((course) => (
            <div
              key={course.id}
              className="flex flex-col gap-4 rounded-lg border border-stone-200 bg-white p-5 transition-shadow hover:shadow-sm lg:flex-row lg:items-center lg:justify-between"
            >
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-stone-400">
                    <span className="flex items-center gap-1">
                      <BookOpen size={12} /> {course._count.modules} módulos
                    </span>
                    <span className="flex items-center gap-1">
