    ...
    <div className="min-h-screen bg-ivory flex items-center justify-center p-4">
      <m.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.4, 0, 0.2, 1] }} className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-stone-400 text-xs text-center mb-8">Regístrate para acceder al catálogo</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4 mb-6">
            {[
              ...
              <div key={f.id} className="space-y-2">
                <label htmlFor={f.id} className="block text-[10px] font-medium text-stone-500 uppercase tracking-[0.15em]">
                  {f.label}
                </label>
                <input
                  id={f.id}
